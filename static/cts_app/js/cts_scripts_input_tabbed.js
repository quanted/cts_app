	...
	$("input[value='Submit']").click(function (e) {
        ...
        if (valid) {
        	$.blockUI({
			  ...
			  message: '<div id="pchem_wait"><h2 class="popup_header">Processing Model Submission...</h2><br/><img src="/cts/static/cts_app/images/loader.gif" style="margin-top:-16px"></div>',
			  fadeIn:  500
			});
