...
urlpatterns += patterns('views',
    ...
    (r'^cts/contact/?$', 'misc.blankLanding'),
    (r'^cts/fifra/?$', 'misc.blankLanding'),
    (r'^cts/flame/?$', 'misc.blankLanding'),
    (r'^cts/ahydrolysis/?$', 'misc.blankLanding'),
    (r'^cts/areduction/?$', 'misc.blankLanding'),
    (r'^cts/mammet/?$', 'misc.blankLanding'),
    ...
    (r'^cts/(?P<model>.*?)/batch/?$', 'misc.blankLanding'),
